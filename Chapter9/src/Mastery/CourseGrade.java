...
Program: CourseGrade.java          Last Date of this Revision: April 20, 2026
...
public class CourseGrade {
    public static void main(String[] args) {
        ...
        System.out.println("\n--- Student Averages ---");
        for (int i = 0; i < 12; i++) {
            System.out.println("Student " + (i + 1) + " Average: " + gb.studentAvg(i));
        }

        System.out.println("\n--- Test Averages ---");
        for (int i = 0; i < 5; i++) {
            System.out.println("Test " + (i + 1) + " Average: " + gb.testAvg(i));
        }
    }
}
